...
# The goal is to predict the total transaction volume per merchant_id on a daily basis for the last 3 months of 2020.
###############################################################

# Dataset Story
#The data contains records from 7 merchants between 2018 and 2020.
...
# Task 1: Data Exploration
        ...
        # 1. Load the "iyzico_data.csv" file. Convert the "transaction_date" variable to a date type.
        ...
        # 5. Observe the transaction count graphs for each merchant within each year.

# Task 2: Apply Feature Engineering techniques. Generate new features.
...
df = pd.read_csv("C:\\Users\\hazal\\Downloads\\Iyzico-221127-235416\\iyzico_data.csv")
...
df.loc[df["transaction_date"].isin(["2018-06-19","2018-06-20","2018-06-21","2018-06-22","2019-06-19","2019-06-20","2019-06-21","2019-06-22",]),"is_summer_solstice"]=1
